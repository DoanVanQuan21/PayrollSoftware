namespace YoloDotNet
{
    public class Yolo : IDisposable
    {
        ...
        public Task<List<ObjectDetection>> RunObjectDetectionAsync(SKImage img, double confidence = 0.23, double iou = 0.7)
            => ((IObjectDetectionModule)_detection).ProcessImageAsync(img, confidence, iou);
        /// <summary>
