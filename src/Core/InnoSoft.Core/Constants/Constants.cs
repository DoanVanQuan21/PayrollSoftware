...
namespace InnoSoft.Core.Constants
{
    ...
    {
        public static string CONFIGURATION => Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), Path.Combine("InnoSoft", "configurations"));
    }
